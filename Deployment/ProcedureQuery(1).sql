...
AS
	SELECT  [ID_Person], [Name], [Surname] , [Patronymic], [Gender], [Birthday], [Mobile], [NameOfRole], [Experience], [On_holiday], [Salary], [Bankcard_number]
	FROM [dbo].[Personal]
...
SET ARITHABORT ON
		INSERT INTO [dbo].[Personal]([ID_Person], [Name], [Surname] , [Patronymic], [Gender], [Birthday], [Mobile], [NameOfRole], [Experience], [On_holiday], [Salary], [Bankcard_number]) 
			SELECT 
